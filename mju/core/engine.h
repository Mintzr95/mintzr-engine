...
public:
 ...
 AnimationLibrary& animations(){return animations_;} const AnimationLibrary& animations()const{return animations_;}
 AudioSystem& audio(){return audio_;} physics::World& physics(){return physics_;} particles::Emitter& particles(){return particles_;} resources::ResourceCatalog& resources(){return resources_;}
 tilemap::TileMap& tilemap(){return tilemap_;} const tilemap::TileMap& tilemap()const{return tilemap_;}
 ui::Canvas& ui(){return ui_;} const ui::Canvas& ui()const{return ui_;} scripting::ScriptVM& scripts(){return scripts_;} debug::Console& console(){return console_;}
