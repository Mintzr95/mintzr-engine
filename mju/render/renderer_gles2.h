...
private:
    ...
    GLuint program_=0; GLint pos_=-1,color_=-1,uv_=-1,texture_sampler_=-1;
    GLuint vertex_buffer_=0,index_buffer_=0,white_texture_=0;
    int width_=1,height_=1;
    std::size_t last_quad_count_=0,last_vertex_count_=0,last_batch_count_=0;
    render::SpriteBatch batch_{2048};
    assets::TextureCache texture_cache_;
    std::unordered_map<std::string,GLuint> gpu_textures_;
};
}
